...
A twbx analysis tool for peeking inside Tableau workbooks and unraveling their structure and logic.
...
**VizVerso** analyzes the internal structure of Tableau workbooks (.twb / .twbx) so you can visualize and export dependencies between dashboards, worksheets, calculated fields, parameters, and data sources.
...
- **マルチレイヤー解析**: 二重軸やマップレイヤーなど、Tableau 特有の複雑なペイン構造にも対応。
...
- **Multi-layer Analysis**: Handles complex pane structures such as dual axes and map layers.
